...
const BorrowerLoanDetailsModal = ({ loan, onClose }) => {
  if (!loan) return null;
    ...
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50">
      ...
      >
        ...
        <div className="space-y-3 text-gray-800 mb-6">
          ...
          <p>
            <span className="font-medium text-gray-600">Lender Name:</span>{" "}
...
export default BorrowerLoanDetailsModal;
